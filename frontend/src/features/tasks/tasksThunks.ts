...
export const fetchTasksByProject = createAsyncThunk<Task[], string>('tasks/fetchByProject', async (id) => {
  const response = await axiosApi.get(`/tasks?project=${id}`);
  return response.data;
});

export const fetchTasksByUser = createAsyncThunk<Task[], string>('tasks/fetchByUser', async (id) => {
  const response = await axiosApi.get(`/tasks?user=${id}`);
  return response.data;
});

export const fetchOneTask = createAsyncThunk<Task, string>('tasks/fetchOne', async (id) => {
...
export const removeTask = createAsyncThunk<void, string>('tasks/remove', async (id) => {
...
export const taskToggleStatus = createAsyncThunk<void, Task>('tasks/toggleStatus', async (task) => {
  try {
